...
},{"run-parallel":3}],3:[function(require,module,exports){
...
function dragStart(dragStartDo) {
    dragStartDo.dataTransfer.setData('text/plain', dragStartDo.target.id);

    dragStartDo.currentTarge.style.bacgroundColor ='blue';
}
},{"drag-drop":2}]},{},[4]);
